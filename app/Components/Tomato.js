  ...
  return (
    ...
    <div className='flex flex-col w-72 h-[70vh] sm:h-[0vh]  m-auto '>
        <div className='w-full rounded-2xl h-60  '>
                    <img className='w-full rounded-2xl h-60 bg-cover' src="https://images.unsplash.com/photo-1571680322279-a226e6a4cc2a?q=80&w=1786&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
        </div>
        <div className='text-center mt-5'>
            <h1 className='font-bold text-2xl text-[#45595B]'>Organic Tomato</h1>
        </div>
